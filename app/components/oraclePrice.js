...
class Blockchain extends React.Component {
  ...
  async setValue(e) {
    ...
    OraclePrice.methods.set(value).send();
    this._addToLog("OraclePrice.methods.set(value).send()");
  }

  getValue(e) {
    e.preventDefault();

    OraclePrice.methods.get().call().then(_value => this.setState({ valueGet: _value }));
    this._addToLog("OraclePrice.methods.get(console.log)");
  }
